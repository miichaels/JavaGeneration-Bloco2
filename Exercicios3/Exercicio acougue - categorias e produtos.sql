...
-- Seleciona da tabela produtos onde o valor seja entre 50.00 e 150.00
...
-- Seleciona as tabelas e une as mesmas, imprimindo a descricao - Aves
select * from tb_produtos inner join tb_categoria on  tb_categoria.id = tb_produtos.categoria_id where descricao = "Aves";
